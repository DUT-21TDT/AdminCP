const addDeleteBtnEvent = function () {
    ...
    if (confirm(msg)) {
        $.ajax({
            url: `/AdminCP/Menus/delete/${menuId}`,
...
const setMenuStatusBtnEvent = function () {
    ...
    if (confirm(msg)) {
        $.ajax({
            url: `/AdminCP/Menus/set/public/${menuId}`,
...
const DataShow2Table = (data, curr_page, page_size = 10)=> {
    ...
    $.each(data, (i, m) => { 
        ...
        trHtml += `<td style="text-align: center;">${m.creator}</td>
                    <td style="text-align: center;">${m.favoriteCount}</td><td style="text-align: center;">`
        ...
        <a href="/AdminCP/Menus/edit/${m.menuid}" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Chỉnh sửa thông tin thực đơn">
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5v11z"/>
            ...
            <a href="/AdminCP/Menus/info/${m.menuid}" class="btn btn-primary btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="Xem thông tin thực đơn">
